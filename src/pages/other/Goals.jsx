  ...
  const content1 = {
    ...
    body: (
      <>
        ...
        <p style={paragraphStyle}>
          SIGN is a tech company which offers <span style={{ color: "#ff6600", fontWeight: "900", fontSize: "clamp(1.1rem, 2.8vw, 1.4rem)", textShadow: "0 0 10px rgba(255, 102, 0, 0.5)" }}>MONEY</span>, <span style={{ color: "#ff6600", fontWeight: "900", fontSize: "clamp(1.1rem, 2.8vw, 1.4rem)", textShadow: "0 0 10px rgba(255, 102, 0, 0.5)" }}>FREEDOM</span> and <span style={{ color: "#ff6600", fontWeight: "900", fontSize: "clamp(1.1rem, 2.8vw, 1.4rem)", textShadow: "0 0 10px rgba(255, 102, 0, 0.5)" }}>INTEGRITY</span>. FOR MONEY: Sign owns TokenTable which is the largest airdrop distribution system which has generated millions of dollars. Airdrops like notcoin and Kaito was distributed using the TokenTable. FOR FREEDOM: Sign created SignPass which is the on-chain residency card that will be adopted by many more countries. FOR INTEGRITY: Sign created Sign Protocol formerly known as ethsign which allows users to verify everything on-chain for instance signing of contract.
        </p>
        <p style={paragraphStyle}>
